            ...
            <div className={cx('container')}>
                ...
                <div className={cx('box_header')}>
                    ...
                    <div className={cx('title')}>
                        <h2 className={cx('title_text')}>NHÀ SỐ 24 - PHÒNG 101</h2>
                ...
                <div className={cx('box_footer')}>
                    ...
                    <div className={cx('footer_function')}>
                        <div className={cx('function_text')}>
                            <label htmlFor={'checkbox'} className={cx('cb')}>
                                <input type={'checkbox'} id={'checkbox'} className={cx('cb1')} />
